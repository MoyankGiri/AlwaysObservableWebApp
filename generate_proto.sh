...
python -m grpc_tools.protoc -I=_proto --python_out=. --grpc_python_out=microservices/$3/src _proto/$4.proto

python -m grpc_tools.protoc -I=_proto --python_out=microservices/$3/src _proto/$4.proto